...
// NOTE: the upstream `CanvasRenderingContext2D.roundRect?` augmentation is intentionally
// dropped — TypeScript 6's bundled lib.dom already declares `roundRect` (non-optional), and
// merging an optional override here would make every call site "possibly undefined".
